  ...
  \cventry
    ...
    {} % Date(s)
    {
      \begin{cvitems} % Description(s)
        \item {Built a CLI and easily deployable daemon in Golang to automate service updates, builds, and deployments with Docker - used by 4 teams at UBC Launch Pad with 8000+ downloads, 20+ contributors, and 100+ stars}
